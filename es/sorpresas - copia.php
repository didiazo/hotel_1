...
<head>
	...
	<style>
	html,body,.body-section,.animsition,.container,.content,.responsive{min-height:100%;margin:0;padding:0;}
	header{position:inherit}
	.menu,.menu-bottom{position:fixed}
...
<div class="animsition">
	<ul id="cbp-bislideshow" class="cbp-bislideshow">
		<li><img src="<?=$url;?>/img/servicios/1.jpg" alt="image01"/></li>
		<li><img src="<?=$url;?>/img/servicios/2.jpg" alt="image02"/></li>
		<li><img src="<?=$url;?>/img/servicios/3.jpg" alt="image03"/></li>
		<li><img src="<?=$url;?>/img/servicios/4.jpg" alt="image04"/></li>
		<li><img src="<?=$url;?>/img/servicios/5.jpg" alt="image05"/></li>
		<li><img src="<?=$url;?>/img/servicios/6.jpg" alt="image06"/></li>
		<li><img src="<?=$url;?>/img/servicios/7.jpg" alt="image07"/></li>
		<li><img src="<?=$url;?>/img/servicios/8.jpg" alt="image08"/></li>
	</ul>
	<div class="container">
