...
<head>
	...
	<title>Habitación Domus Mare Vista al Mar</title>
	<script>
...
<div class="animsition">
	...
	<ul id="cbp-bislideshow" class="cbp-bislideshow">
		<li><img src="<?=$url;?>/img/rooms/domus-mare-vista-al-mar/1.jpg" alt="image01"/></li>
		<li><img src="<?=$url;?>/img/rooms/domus-mare-vista-al-mar/2.jpg" alt="image02"/></li>
		<li><img src="<?=$url;?>/img/rooms/domus-mare-vista-al-mar/3.jpg" alt="image03"/></li>
		<li><img src="<?=$url;?>/img/rooms/domus-mare-vista-al-mar/4.jpg" alt="image04"/></li>
		<li><img src="<?=$url;?>/img/rooms/domus-mare-vista-al-mar/5.jpg" alt="image05"/></li>
		<li><img src="<?=$url;?>/img/rooms/domus-mare-vista-al-mar/6.jpg" alt="image06"/></li>
	</ul>
	...
	<form class="formhab" action="<?=$url;?>/es/reservas-y-tarifas.php" method="get">
		<a href="<?=$url;?>/es/habitacion/superior-premium-deluxe-vista-al-mar" class="cbp-biprev"></a>
		<input type="hidden" name="room" value="6" />
		<input type="submit" value="Reservar" />
		<a href="<?=$url;?>/es/habitaciones" class="cbp-binext"></a>
	</form>
