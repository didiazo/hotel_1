...
<head>
	...
	<title>Habitación Superior</title>
	<script>
...
<div class="animsition">
	...
	<ul id="cbp-bislideshow" class="cbp-bislideshow">
		<li><img src="<?=$url;?>/img/rooms/superior/1.jpg" alt="image01"/></li>
		<li><img src="<?=$url;?>/img/rooms/superior/2.jpg" alt="image02"/></li>
		<li><img src="<?=$url;?>/img/rooms/superior/3.jpg" alt="image03"/></li>
		<li><img src="<?=$url;?>/img/rooms/superior/4.jpg" alt="image04"/></li>
	</ul>
	...
	<form class="formhab" action="<?=$url;?>/es/tarifas-reservas.php" method="get">
		<a href="<?=$url;?>/es/habitaciones" class="cbp-biprev"></a>
		<input type="hidden" name="room" value="1" />
		<input type="submit" value="Reservar" />
		<a href="<?=$url;?>/es/habitacion/premium-vista" class="cbp-binext"></a>
	</form>
