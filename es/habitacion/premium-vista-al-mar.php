...
<head>
	...
	<title>Habitación Premium Vista al Mar</title>
	<script>
...
<div class="animsition">
	...
	<ul id="cbp-bislideshow" class="cbp-bislideshow">
		<li><img src="<?=$url;?>/img/rooms/premium-vista-al-mar/1.jpg" alt="image01"/></li>
		<li><img src="<?=$url;?>/img/rooms/premium-vista-al-mar/2.jpg" alt="image02"/></li>
		<li><img src="<?=$url;?>/img/rooms/premium-vista-al-mar/3.jpg" alt="image03"/></li>
		<li><img src="<?=$url;?>/img/rooms/premium-vista-al-mar/4.jpg" alt="image04"/></li>
	</ul>
	...
	<form class="formhab" action="<?=$url;?>/es/tarifas-reservas.php" method="get">
		<a href="<?=$url;?>/es/habitacion/premium-vista" class="cbp-biprev"></a>
		<input type="hidden" name="room" value="3" />
		<input type="submit" value="Reservar" />
		<a href="<?=$url;?>/es/habitacion/premium-deluxe-vista-al-mar" class="cbp-binext"></a>
	</form>
